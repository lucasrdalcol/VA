function [allData, scenario, sensors] = TP2_Cenario_9()
%TP2_Cenario_9 - Returns sensor detections
%    allData = TP2_Cenario_9 returns sensor detections in a structure
%    with time for an internally defined scenario and sensor suite.
%
%    [allData, scenario, sensors] = TP2_Cenario_9 optionally returns
%    the drivingScenario and detection generator objects.

% Generated by MATLAB(R) 9.11 (R2021b) and Automated Driving Toolbox 3.4 (R2021b).
% Generated on: 10-Feb-2022 12:03:24
...
car11 = vehicle(scenario, ...
    'ClassID', 1, ...
    'Position', [94.04 -44.16 0.01], ...
    'Mesh', driving.scenario.carMesh, ...
    'Name', 'Car11');
waypoints = [94.04 -44.16 0.01;
    83.7 -50.8 0;
    77.8 -55.9 0;
    70.2 -61.4 0;
    60.8 -67.9 0;
    ...
    111.7 -121.8 0;
    122.3 -124.5 0];
speed = [4;4;4;4;4;4;4;4;4;4;4;4;4;4;4;4];
